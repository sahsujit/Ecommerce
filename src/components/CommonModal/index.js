    ...
    <Transition.Root show={show} as={Fragment}>
      <Dialog as="div" className={"relative z-10"} onClose={setShow}>
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 bg-richblack-800 bg-opacity-75 transition-opacity" />
        </Transition.Child>
            ...
            <div className="fixed inset-y-0 right-0 flex max-w-full pl-10">
              ...
              >
                <Dialog.Panel className={"w-screen max-w-md"}>
                  <div className="flex h-full flex-col overflow-y-scroll bg-richblack-900 shadow-xl">
